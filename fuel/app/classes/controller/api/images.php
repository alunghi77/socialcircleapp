...
{    
    ...
    {  
        ...
        $unique_id  = uniqid();
        $img        = DOCROOT.'files'.DS.'feeds'.DS.$file_info['basename'];
        ...
        echo 'http://'.$_SERVER['HTTP_HOST'].DS.'assets'.DS.'files'.DS.'feeds'.DS.'cropped_'.$unique_id.$file_info['basename'];
            ...
            if ( !$response_arr['error'] ){
                ...
                switch ( true ){
                    ...
                    case (in_array(Str::lower($response_arr['extension']), $video_ext_whitelist)) : 
                        ...
                        $FFmpeg
                            ->input( DOCROOT . 'files' . DS . 'feeds' . DS . $response_arr["saved_as"] )
                        ...
                        $data = array(
                            ...
                            'preview' => array(
                                ...
                                'image_src'     => Uri::base(false). 'files' . DS . 'feeds' . DS . $unique_id . '.jpg',
