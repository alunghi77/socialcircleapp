...
(function() {
  var auth_user, create_circle, create_comment, create_feed, create_user, feed_events, find_user, media_uploader, preview_media, preview_media_api, switch_circle;
  ...
  create_comment = function(e) {
    ...
    $.post("/api/comments/" + obj["id"], obj, function(res, status) {
      ...
      if (res.head.success) {
        ...
        return $(html).insertBefore($target);
      }
    }).fail(function() {
